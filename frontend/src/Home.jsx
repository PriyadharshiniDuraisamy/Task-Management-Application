    ...
    <div>
        ...
        <nav className="navbar">
          ...
          <ul>
            ...
            <li className="dropdown">
              <li><Link to="/Profile" target="blank">Profile</Link></li>
      ...
      <footer>
        <div className="footer">
          ...
          <div className="row">
            <ul>
            <li><a href="mailto:PNP@example.com"> Contact us</a></li>
          ...
          <div className="row">
            TO-DO SPRINT Copyright © 2024  PNP -
            All rights reserved || Designed By: PNP
          </div>
        </div>
      </footer>
    </div>
